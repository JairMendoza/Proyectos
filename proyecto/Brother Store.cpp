...
void abrir()
 {
 	pf = fopen("C:\\Users\\USER\\Documents\\proyecto\\Usuarios.bin","rb");
 	if(pf==NULL)
	{
		pf=fopen("C:\\Users\\USER\\Documents\\proyecto\\Usuarios.bin","wb");
 ...
 void ingresar()
 {
 	...
 	pf2=fopen("C:\\Users\\USER\\Documents\\proyecto\\Recargas.bin","ab+");
 	pv=fopen("C:\\Users\\USER\\Documents\\proyecto\\Ventas.bin","ab+");
 	if((pf = fopen("C:\\Users\\USER\\Documents\\proyecto\\Usuarios.bin","rb")) == NULL)
	{
	...
	Sleep(2500);
 	if(reg==1)
 	{
		...
		pm=fopen("C:\\Users\\USER\\Documents\\proyecto\\Articulos.bin","rb+");
		do
    	{
    		c=fgetc(pm);
			if(c!=EOF)
 ...
 void alta_user()
{
	...
	char q;
	int lonu=0,lonc=0;
	pf=fopen("C:\\Users\\USER\\Documents\\proyecto\\Usuarios.bin","ab+");
	do
	{
		system("cls");
		ban=0;
...
void add_articulo()
{
	...
	pf=fopen("C:\\Users\\USER\\Documents\\proyecto\\Articulos.bin","ab+");
	pv=fopen("C:\\Users\\USER\\Documents\\proyecto\\Ventas.bin","ab+");
	pf2=fopen("C:\\Users\\USER\\Documents\\proyecto\\Articulos.bin","rb+");
	pm=fopen("C:\\Users\\USER\\Documents\\proyecto\\Marcas_Articulos.bin","ab+");
	pc=fopen("C:\\Users\\USER\\Documents\\proyecto\\Categoria_Articulos.bin","ab+");
	do
	{
...
void modificar_articulo()
{
	...
	pf=fopen("C:\\Users\\USER\\Documents\\proyecto\\Articulos.bin","rb+");
	pm=fopen("C:\\Users\\USER\\Documents\\proyecto\\Marcas_Articulos.bin","rb+");
	pc=fopen("C:\\Users\\USER\\Documents\\proyecto\\Categoria_Articulos.bin","rb+");
	do
	{
		do
		{
...
void mostrar()
{
	int y=7;
	pf=fopen("C:\\Users\\USER\\Documents\\proyecto\\Articulos.bin","rb");
	if((pf = fopen("C:\\Users\\USER\\Documents\\proyecto\\Articulos.bin","rb")) == NULL)
	{
		cout << "¡No se encontro el archivo para la lectura!";
		exit(0);
		getch();
...
void venta()
{
	...
	pm=fopen("C:\\Users\\USER\\Documents\\proyecto\\Marcas_Articulos.bin","rb+");
	pc=fopen("C:\\Users\\USER\\Documents\\proyecto\\Categoria_Articulos.bin","rb+");
	pf2=fopen("C:\\Users\\USER\\Documents\\proyecto\\Recargas.bin","rb+");
		if(cod==1)
		{
...
void mermas()
{
	...
	pm=fopen("C:\\Users\\USER\\Documents\\proyecto\\Marcas_Articulos.bin","rb+");
	pc=fopen("C:\\Users\\USER\\Documents\\proyecto\\Categoria_Articulos.bin","rb+");
	pa=fopen("C:\\Users\\USER\\Documents\\proyecto\\Mermas.bin","ab+");	
		if(cod==1)
		{
			gotoxy(20,5);cout<<"NO a registrado articulos.";
			gotoxy(20,6);cout<<"Ingrese a la opcion de añadir articulo para registrar uno nuevo.";
...
void faltantes()
{
	...
	else
	{
		...
		do
		{
			...
			else if(c!=EOF&&articulo.eliminado==0&&articulo.cantidad<3&&!strcmpi(otro,articulo.categoria))
			{
				gotoxy(15,y);cout<<"|"<<articulo.codigo;gotoxy(25,y);cout<<"|"<<articulo.nom;gotoxy(40,y);cout<<"| $"<<articulo.precio;gotoxy(50,y);cout<<"|"<<articulo.marca;gotoxy(65,y);cout<<"|"<<articulo.categoria;gotoxy(85,y);cout<<"|"<<articulo.cantidad;
				y++;
			}
			...
			else if(c!=EOF&&articulo.eliminado==0&&articulo.cantidad<2&&!strcmpi(bateria,articulo.categoria))
			{
				gotoxy(15,y);cout<<"|"<<articulo.codigo;gotoxy(25,y);cout<<"|"<<articulo.nom;gotoxy(40,y);cout<<"| $"<<articulo.precio;gotoxy(50,y);cout<<"|"<<articulo.marca;gotoxy(65,y);cout<<"|"<<articulo.categoria;gotoxy(85,y);cout<<"|"<<articulo.cantidad;
				y++;
			}
...
{
	int y=7;
	pf=fopen("C:\\Users\\USER\\Documents\\proyecto\\Mermas.bin","rb");
	if((pf = fopen("C:\\Users\\USER\\Documents\\proyecto\\Mermas.bin","rb")) == NULL)
	{
		cout << "¡No se encontro el archivo para la lectura!";
		exit(0);
		getch();
...
void recarga()
{
	...
	char pre2[7];
	pf=fopen("C:\\Users\\USER\\Documents\\proyecto\\Recargas.bin","rb+");
	do
	{
		vali=0;
